package pl.edu.wat.wcy.isi.ai.transportapp.config;

import pl.edu.wat.wcy.isi.ai.transportapp.domain.util.JSR310DateConverters.*;
...
@Configuration
@EnableMongoRepositories("pl.edu.wat.wcy.isi.ai.transportapp.repository")
...
public class CloudDatabaseConfiguration extends AbstractCloudConfig {
    ...
    public Mongobee mongobee(MongoDbFactory mongoDbFactory) throws Exception {
        ...
        mongobee.setChangeLogsScanPackage("pl.edu.wat.wcy.isi.ai.transportapp.config.dbmigrations");
